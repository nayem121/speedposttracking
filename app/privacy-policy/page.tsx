...
export const metadata = {
  title: "Privacy Policy - Speed Post Tracking - India App",
  description:
    "Privacy policy for the Speed Post Tracking - India mobile application developed by Youth Empowerment Center.",
}
      ...
      <main className="container mx-auto px-4 py-12">
        <Card className="max-w-4xl mx-auto">
          <CardHeader className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-2">Speed Post Tracking - India App</p>
            <p className="text-sm text-gray-500 dark:text-gray-400">Effective Date: July 31, 2025</p>
          </CardHeader>
          <CardContent className="prose prose-gray dark:prose-invert max-w-none">
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              This privacy policy applies to the Speed Post Tracking - India app (hereby referred to as "Application")
              for mobile devices that was created by Youth Empowerment Center (hereby referred to as "Service Provider")
              as a Free service. This service is intended for use "AS IS".
            </p>

            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-6">
              <p className="text-amber-800 dark:text-amber-200 text-sm">
                <strong>Important Notice:</strong> This is a third-party application and is not affiliated with or
                endorsed by India Post or Speed Post services. We are an independent service provider offering tracking
                functionality for India Post Speed Post parcels.
              </p>
            </div>
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-6">
              ...
              <li>Speed Post tracking numbers and consignment numbers you enter for parcel tracking purposes</li>
            </ul>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Third Party Access</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Opt-Out Rights</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Data Retention Policy</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              ...
              Application, please contact them at nayem121@programmer.com and they will respond in a reasonable time.
            </p>

            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Children</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              ...
              (nayem121@programmer.com) so that they will be able to take the necessary actions.
            </p>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Changes</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Your Consent</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              ...
              <Link
                href="mailto:nayem121@programmer.com"
                className="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300"
              >
                nayem121@programmer.com
              </Link>
            </p>
          </CardContent>
        </Card>
